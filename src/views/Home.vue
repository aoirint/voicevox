...
export default defineComponent({
  ...
  setup() {
    ...
    const allEngineState = computed(() => {
      ...
      // NOTE: 1つもエンジンが登録されていない場合はSTARTING
      let lastEngineState: EngineState = "STARTING";
      ...
      for (const engineKey of engineKeys) {
        ...
        // NOTE: 1つでも接続テストに成功していないエンジンがあれば、暫定的に起動中とする
      ...
      return lastEngineState; // NOTE: 暫定的に1つのエンジンの状態を返す
    });
